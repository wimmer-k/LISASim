...
//---------------------------------------------------------
void Beam::setmaxAta(G4double d)
{
...
//---------------------------------------------------------
void Beam::setmaxBta(G4double d)
{
...
//-----------------------------------------------------------------
void Beam::setKEu(G4double KEuin)
{
...
//---------------------------------------------------------
G4ThreeVector Beam::getDirection()
{
...
//---------------------------------------------------------
G4ThreeVector Beam::getPosition()
{
  ...
  position.setY(y);
  position.setZ(fcZ);
  G4cout << x << "\t" << y << "\t" << fcZ << G4endl;
  return position;
  
}

//---------------------------------------------------------
G4double Beam::getKE(G4ParticleDefinition *ion)
{
