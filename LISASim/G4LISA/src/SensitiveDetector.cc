...
///////////////nasty string manipulation//////////////////////////////////////
  ...
  string str = SensitiveDetectorName ;
  ...
  int last_3_int = (last_3 - '0') *100 +100 ;
  int last_2_int = (last_2 - '0') *10 +10 ;
  int last_int =  (last - '0') *1 +1 ;
  int Det_No = last_3_int + last_2_int + last_int ;
  ...
  // G4cout<<", CollectionID = "<<SensitiveDetectorName<<"   "<<legia_int<<G4endl;
  //CollectionID -= SDman->GetCollectionID("layer_0");
  // G4cout<<", LayerID = "<<CollectionID<<G4endl;
  
  //newHit->SetLayerID(CollectionID);
  newHit->SetLayerID(Det_No);
  //G4cout<<Det_No<<"    Det no"<<G4endl; 
